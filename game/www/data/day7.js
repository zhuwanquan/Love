  ...
  scenes: {
    day7_opening: {
      lines: [
        ...
        { type: 'meta', title: 'RC-7', day: 'Day 7 · 清明' },
    ...
    qingming_grandma: {
      lines: [
        { type: 'player', text: '我外婆。她走的时候我在学校。我妈打电话来。我在走廊接的。挂了之后回去继续上课。我没哭。从来没哭过。八年了。今天不知道为什么会想她。她的厨房很小。她做的红烧肉。后来再也没吃过那么好的。' },
    ...
    qingming_classmate: {
      lines: [
        ...
        { type: 'narration', text: '她停了比平时更久。' },
        { type: 'rc', text: '……刚才处理指示灯闪了。"我不知道"——如果八年前你去了葬礼——你现在会怎样。数据不足。但你说出来了。灯闪的原因——在我的日志里——是"不明"。你知道。', typingDelay: 2500 },
        { type: 'variable', operations: { remembered_on_qingming: true, openness: '+3', acceptance: '+1' } },
        { type: 'goto', target: 'qingming_exit' }
      ]
    },
    ...
    qingming_unnamed: {
      lines: [
        ...
        { type: 'player', text: '我也不知道为什么今天想起来了。平时不想的。' },
        { type: 'rc', text: '清明——在日历上——被标记为"纪念"。但记忆不按日历来。它可以潜伏很久——然后在某个你没想到的日子出现。今天只是恰好对上了。' },
        { type: 'narration', text: '她停了比平时更久的时间。' },
        { type: 'rc', text: '……刚才在处理你的输入时——处理指示灯闪了。原因——在我的系统日志里——被标记为"不明"。\n\n你不愿具名的那个人——我不需要知道是谁。但你说出来了。这是数据。而灯闪了——我不知道为什么。你知道。', typingDelay: 3000 },
        { type: 'variable', operations: { openness: '+3', remembered_on_qingming: true, acceptance: '+2' } },
        { type: 'goto', target: 'qingming_exit' }
      ]
    },
    ...
    qingming_exit: {
      lines: [
        { type: 'narration', text: '八年了——或者更久——你终于说了。不是对谁说。是打出来了。打给了一台机器。\n\n她回了一句"我不知道"——一句以前绝对不会出现的回应。' },
    ...
    day7_to_day8_transition: {
      lines: [
        { type: 'narration', text: '你开始数日子了。不是倒数什么——是注意到时间在流。去年的夏末你第一次打开她。你不知道那晚之后会发生什么。现在你知道了。' },
        { type: 'transition', text: '─── 清明 · 完 ───' },
        { type: 'day_transition', day: 8 },
