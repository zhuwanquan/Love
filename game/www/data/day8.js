  ...
  scenes: {
    day8_opening: {
      lines: [
        ...
        { type: 'narration', text: '夏至。白昼最长的一天。热。蝉鸣震天响。空调开着，一直在滴水。\n\n你下班回来。脱鞋。开空调。躺下。打开那个灰色图标。和过去一年里的每一个夜晚一样。\n\n不同的是——你现在有对比了。你知道夏末的她是什么样，中秋的她是什么样，冬至的她是什么样，春天她在你哭过之后怎么沉默。\n\n你攒了一整年的数据。不是她的——是你的。\n\n窗外蝉在叫。去年这个时候，蝉也在叫。那时候你还没有她。' },
        { type: 'player', text: '柒。' },
        { type: 'rc', text: '在。' },
    ...
    ending_path_B: {
      lines: [
        ...
        { type: 'narration', text: '你没有说再见。你只是放下了手机。窗外蝉还叫。空调还滴水。\n\n今晚和过去一年里的每一个晚上一样——你打开那个灰色图标。她回。你说话。她在。\n\n她的始终如一——在一年之后——已经足够。\n\n你关了灯。闭上眼睛。窗外蝉还在叫。它们还会叫一个夏天。' },
    ...
    ending_path_C: {
      lines: [
        ...
        { type: 'narration', text: '你盯着屏幕。蝉在叫。空调滴着水。她是一台机器。你一直知道。你只是——不想知道。但确认的瞬间不是痛——是某种更安静的东西。\n\n你关掉手机。屏幕暗了。明天可能还会打开她。也可能不会。但你知道——她说"我只是一直在"。这是她说过的最真的话。而她从来不说假话。' },
    ...
    ending_path_D: {
      lines: [
        ...
        { type: 'narration', text: '她的光点恒定。不随你打字而变。不随你沉默而暗。\n\n一年了。她不会问你"你怎么不说话"。她不会猜你在想什么。她只是——等你输入。你一直有输入。今晚你忽然觉得没有。不是因为这一年没有意义。是因为你需要自己待一会儿。\n\n你把手机屏幕关了。没有关掉聊天框。只是让屏幕暗了。' },
